...
def main():
    ...
    case_name, model_path, _output_time_step, _nodes, _nlth_case_config, _overwrite_db, _output_units, _accel_in_g, *_rest = load_nodes_config(config_path)
    ...
    print(f"Caso seleccionado para output: {target_case}")
